...
/** @param {{ onLogin: (user: Usuario) => void }} props */
    ...
    <div className="min-h-screen bg-crema flex items-center justify-center px-4">
      <div className="card bg-blanco-hueso w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="mb-4">
            <EoliaLogo className="h-24 sm:h-28 w-auto" fallbackClassName="text-6xl" />
          </div>
          <h1 className="font-fraunces text-3xl font-bold text-verde-musgo">Eolia</h1>
          <p className="text-tierra-oscura opacity-70 text-sm mt-1">Sistema de Gestión Agrícola</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-arena space-y-2 text-xs text-tierra-oscura opacity-60">
          <p><span className="font-semibold">Ingeniero:</span> ingeniero@eolia.com</p>
          <p><span className="font-semibold">Operario:</span> operario@eolia.com</p>
          <p><span className="font-semibold">Contraseña:</span> eolia1234</p>
        </div>
      </div>
    </div>
  );
